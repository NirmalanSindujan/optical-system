...
@Getter
@Builder
@Schema(description = "Response payload after creating progressive lens variants")
public class ProgressiveCreateResponse {
    ...
    private List<ProgressiveVariantResponse> variants;
}
