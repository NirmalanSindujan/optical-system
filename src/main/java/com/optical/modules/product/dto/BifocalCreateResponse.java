...
@Getter
@Builder
@Schema(description = "Response payload after creating bifocal lens variants")
public class BifocalCreateResponse {
    ...
    private List<BifocalVariantResponse> variants;
}
