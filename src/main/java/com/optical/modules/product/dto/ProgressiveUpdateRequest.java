...
@Getter
@Setter
@Schema(description = "Update request for a single progressive lens item")
public class ProgressiveUpdateRequest {
    ...
    @NotNull
    @Schema(description = "ADD power. Range -4 to 4, step 0.25", requiredMode = Schema.RequiredMode.REQUIRED)
